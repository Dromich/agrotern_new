		...
		<div class="main_width">
			...
			<div class="">
				...
				<div class="block_catalog">
					<div class="card_product">
						<div class="event">
							<span class="hit" style="background-color: #ff7200;">Новинка</span>
						</div>
						<div class="name_product three">
							<b>
								<span>Минитрактор ВИТЯЗЬ VM</span>
								<span>150 RX</span>
							</b>
							<span class="manufacture">Витязь</span>
						</div>
					...
					<div class="titles">
						<ul>
							...
							<li>
								...
								<span>населенные пункты Украины</span>
							</li>
							<li>
								<span>
									<span>Огромный ассортимент товаров,</span>
									<span>напрямую от ведущих</span>
									<span>производителей Мира</span>
								</span>
							</li>
						</ul>
					</div>
